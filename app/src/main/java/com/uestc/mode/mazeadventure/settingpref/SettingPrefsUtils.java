...
public class SettingPrefsUtils {
    ...
    //user action
    public static final String IS_FIRST_LOGIN = "is_first_login";//是否第一次登陆
    public static final String IS_LIGHT_MODE_LOCKED = "is_light_mode_locked";//是否光明模式开启
    public static final String IS_DARK_MODE_LOCKED = "is_dark_mode_locked";//是否黑暗模式开启
    ...
    public class DefaultValue{
        ...
        public static final boolean DEFAULT_LIGHT_MODE_LOCKED = true;//是否第一次登陆
        public static final boolean DEFAULT_DARK_MODE_LOCKED = true;//是否第一次登陆
    }
}
